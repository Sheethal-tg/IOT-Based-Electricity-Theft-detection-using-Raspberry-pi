' 
 ...
     def _init_(self, name="HelloWorld", coap_server=None): 
         super(HelloWorld, self)._init_(name, coap_server, visible=True, observable=True, allow_children=True) 
 ...
     def _init_(self, name="InitialImageSet", coap_server=None): 
         super(InitialImageSet, self)._init_(name, coap_server, visible=True, observable=True, allow_children=True) 
 ...
     def _init_(self, name="SetMode", coap_server=None): 
         super(SetMode, self)._init_(name, coap_server, visible=True, observable=True, allow_children=True) 
 ...
      
     def _init_(self, name="BeginTDS", coap_server=None):        
         super(BeginTDS, self)._init_(name, coap_server, visible=True, observable=True, allow_children=True) 
